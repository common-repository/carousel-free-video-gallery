=== ULTIMATE CAROUSEL FREE VIDEO GALLERY ===
Contributors: pluginswp.com
Donate link: http://www.pluginswp.com/ultimate-carousel-video-gallery/
...
With this plugin you can create 3D video galleries with flv videos and/or youtube videos.
...
* <a href="http://www.pluginswp.com/ultimate-carousel-video-gallery/">Plugin page and Demos</a>
...
1. Upload `carousel-free-video-gallery` folder to `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in your Admin.
3. Create and configure a new video gallery in your Wordpress Admin: carouselfree Video
4. To add an Ultimate carouselfree Video Gallery in your post you only have to add 
[`carousel_video` ID /] , where ID is the gallery ID.

5. Admin params:

- Video URL. In this field you have to write the urls of your videos; flv url(s) videos 
or, YouTube url(s) video or ID(s) of YouTube videos. You must add a list where the url of 
the first video would be the first line, the url of the second video the second line, 
...etc
...
= 2.2 = Widget errors corrected

= 2.1 = Widget, size video capture customizable

= 1.2 = Youtube videos issue corrected.
...
= 1.2 = flash plugin required corrected in widget mode